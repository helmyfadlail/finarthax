    ...
    <div className="relative z-50">
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex items-end justify-center min-h-full md:items-center md:p-4" onClick={handleBackdropClick}>
          <div
            className={cn(
              "w-full transform overflow-hidden shadow-2xl transition-all duration-300",
              "rounded-t-2xl p-4",
          ...
          >
            ...
            {(title || showCloseButton) && (
              <div className="flex items-start justify-between mb-3 md:mb-4">
                ...
                {showCloseButton && (
                  <button onClick={onClose} className="ml-3 transition-colors text-primary-400 dark:text-primary-600 hover:text-primary-600 dark:hover:text-primary-800 md:ml-4">
